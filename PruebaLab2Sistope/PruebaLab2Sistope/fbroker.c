...
/*
Entrada: arreglo de pixeles, cantidad de pixeles, iterador, arreglo de pixeles nuevo, cantidad de pixeles añadidos por defecto
Salida: no hay
...
/*
Entrada: arreglo de pixeles, cantidad de pixeles, argumentos para el worker, iterador, arreglo de pixeles nuevo, cantidad de pixeles añadidos por defecto
Salida: no hay
